	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo e(asset('admin/staff/tambah')); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
<?php echo e(csrf_field()); ?>

				<div class="form-group row">
					<label class="col-sm-3 control-label text-right">Nama lengkap</label>
					<div class="col-sm-9">
						<input type="text" name="nama_staff" class="form-control" placeholder="Nama lengkap" value="<?php echo e(old('nama_staff')); ?>" required>
					</div>
				</div>
                ...
                <div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" name="telepon" class="form-control" placeholder="Telepom" value="<?php echo e(old('telepon')); ?>" required>
					</div>
				</div>
                ...
                <div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" name="alamat" class="form-control" placeholder="Alamat" value="<?php echo e(old('alamat')); ?>" required>
					</div>
				</div>
                ...
                <div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" name="jabatan" class="form-control" placeholder="Jabatan" value="<?php echo e(old('jabatan')); ?>" required>
					</div>
				</div>
                ...
                <div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi" value="<?php echo e(old('deskripsi')); ?>" required>
					</div>
				</div>
                ...
                <div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" name="pendidikan" class="form-control" placeholder="Pendidikan" value="<?php echo e(old('pendidikan')); ?>" required>
					</div>
				</div>
				...
				<div class="form-group row">
					<label class="col-sm-3 control-label text-right">Level Status Staff</label>
					<div class="col-sm-9">
...
<?php /**PATH C:\xampp\htdocs\cbt\resources\views/admin/staff/tambah.blade.php ENDPATH**/ ?>