	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo e(asset('admin/client/tambah')); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
<?php echo e(csrf_field()); ?>

				<div class="form-group row">
					<label class="col-sm-3 control-label text-right">Nama lengkap</label>
					<div class="col-sm-9">
						<input type="text" name="nama_client" class="form-control" placeholder="Nama lengkap" value="<?php echo e(old('nama_client')); ?>" required>
					</div>
				</div>
				...
				<div class="form-group row">
					<label class="col-sm-3 control-label text-right">Level Status Client</label>
					<div class="col-sm-9">
...
<?php /**PATH C:\xampp\htdocs\cbt\resources\views/admin/client/tambah.blade.php ENDPATH**/ ?>