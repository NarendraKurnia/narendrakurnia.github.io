...
<tbody>
    ...
    <?php $i=1; foreach($user as $user) { ?>
      ...
      <td class="text-center">
        <?php if($user->gambar != "") { ?>
            <img src="<?php echo e(asset('assets/upload/user/'.$user->gambar)); ?>" class="img img-fluid img-thumbnail">
...
</form><?php /**PATH C:\xampp\htdocs\cbt\resources\views/admin/user/index.blade.php ENDPATH**/ ?>