...
const translations = {
    en: {
        ...
        "myjob-modal-pro1": "â€¢ Built with HTML5, CSS3, JavaScript, Bootstrap, PHP, MySQL.<br>â€¢ Designed database.<br>â€¢ Connected database to the website by applying Advanced Query.<br>â€¢ Enhanced user experience by optimizing the display, site structure, and navigation.",
        ...
        "myjob-modal-pro2": "â€¢ Built website with HTML5, CSS3, PHP, JavaScript, Bootstrap.<br>â€¢ Created database design.<br>â€¢ Created animation and transition with CSS3 dan JavaScript.<br>â€¢ Developed desktop website to responsive website.<br>â€¢ Built function from additional item to cart by applying JSON to collect itemâ€™s information.<br>â€¢ Enhanced user experience by optimizing button function and navigation on the website page.<br>â€¢ Imporved the thankyou.php page to automatically display the code based on the order type (dine in or take away).<br>â€¢ Created admin page and order history page, including order detail modal.<br>â€¢ Created live page on the admin page to view the order code without having to refresh the page. Live page using React.js<br>â€¢ Created notification automatically if there is a new order.",
        ...
        "myjob-modal-pro3": "â€¢ Created database design.<br>â€¢ Created interface desktop app with menggunakan Java Swing.<br>â€¢ Connected desktop app to database with Java JDBC Driver.<br>â€¢ Created user authentication, database management, and data validation.<br>â€¢ Created DSS calculation feature by applying SAW method calculation.<br>â€¢ Enhanced user experience by optimizing button function, display, structure, and navigation on the website page.",
        ...
        "myjob-modal-pro4": "â€¢ Created concepts for application functions.<br>â€¢ Created user interface and user experience.<br>â€¢ Created a dynamic connection between the website, websocket, and OBS.<br>â€¢ Created button functions on the website to run OBS Scenes and Sources.<br>â€¢ Created shortcuts and shortcut settings for each function connected to OBS Scenes and Sources.<br>â€¢ Created Scenes, Sources, and Profile settings in OBS.",
        ...
        "desc-modal-exp1": "My jobdesc during my tenure:<br>â€¢ Coordinated with teacher about publication projects.<br>â€¢ Created video concepts and edited event videos.<br>â€¢ Created concepts and designed Instagram feeds.<br>â€¢ Interacted with audiences and shared informations on Instagram.<br>â€¢ Operated Live Streaming Youtube and Instagram.",
        ...
        "desc-modal-exp2": "My jobdesc during my tenure:<br>â€¢ Coordinated task for team and scheduled the timeline.<br>â€¢ Coordinated with other division to arrange publication and decoration.<br>â€¢ Communicated and negotiated with sponsors to get a sponsorship.<br>â€¢ Created publications concepts.<br>â€¢ Edited sneak peek video, teaser, and after movie.<br>â€¢ Achieved 3.700+ Instagram reels views on teaser.<br>â€¢ Designed Instagram feeds and event poster.",
        ...
        "desc-modal-exp3": "My jobdesc during my tenure:<br>â€¢ Led team and scheduled the timeline.<br>â€¢ Coordinated with other division to arrange publication concepts, merchandise, and videos.<br>â€¢ Communicated and negotiated with sponsors to get sponsorships.<br>â€¢ Created and edited design concept.<br>â€¢ Edited after movie video.<br>â€¢ Designed Instagram feeds, Technical Meeting information, sponsorship proposal, and event poster.",
        ...
        "desc-modal-exp4": "My jobdesc during my tenure:<br>â€¢ Operated Live Streaming of church services.<br>â€¢ Scheduled operator every three months.<br>â€¢ Created concepts and designed Live Stream thumbnail.<br>â€¢ Created concepts and designed Live Stream display.<br>â€¢ Created video bumper.",
    ...
    id: {
        ...
        "myjob-modal-pro1": "â€¢ Membuat situs dengan HTML5, CSS3, JavaScript, Bootstrap, PHP, MySQL.<br>â€¢ Merancang basis data.<br>â€¢ Menghubungkan basis data ke situs web dengan menerapkan Advanced Query.<br>â€¢ Meningkatkan pengalaman pengguna dengan mengoptimalkan tampilan, struktur situs, dan navigasi.",
        ...
        "myjob-modal-pro2": "â€¢ Membuat situs dengan HTML5, CSS3, PHP, JavaScript, Bootstrap. MySQL.<br>â€¢ Membuat desain basis data.<br>â€¢ Membuat animasi dan transisi dengan CSS3 dan JavaScript.<br>â€¢ Mengembangkan situs web desktop menjadi situs web responsif.<br>â€¢ Membuat fungsi dari item tambahan ke keranjang dengan menerapkan JSON untuk mengumpulkan informasi item.<br>â€¢ Meningkatkan pengalaman pengguna dengan mengoptimalkan fungsi tombol dan navigasi pada halaman website.<br>â€¢ Memperbaiki halaman thankyou.php supaya menampilkan kode secara otomatis berdasarkan jenis pesanan (dine in atau take away).<br>â€¢ Membuat halaman admin dan halaman history order, termasuk dengan modal detail pesanan.<br>â€¢ Membuat live halaman pada halaman admin untuk melihat kode pesanan tanpa harus refresh halaman. Live halaman menggunakan React.js.<br>â€¢ Membuat notifikasi secara otomatis jika ada pesanan baru.",
        ...
        "myjob-modal-pro3": "â€¢ Membuat desain basis data.<br>â€¢ Membuat antarmuka aplikasi desktop dengan menggunakan Java Swing.<br>â€¢ Menghubungkan aplikasi desktop ke basis data dengan menggunakan Java JDBC Driver.<br>â€¢ Membuat autentikasi pengguna, manajemen basis data, dan validasi data.<br>â€¢ Membuat fitur perhitungan DSS dengan menggunakan perhitungan metode SAW.<br>â€¢ Meningkatkan pengalaman pengguna dengan mengoptimalkan fungsi tombol, tampilan, struktur, dan navigasi pada halaman situs web.",
        ...
        "myjob-modal-pro4": "â€¢ Membuat konsep untuk fungsi aplikasi.<br>â€¢ Membuat antarmuka pengguna dan pengalaman pengguna.<br>â€¢ Membuat koneksi dinamis antara situs web, websocket, dan OBS.<br>â€¢ Membuat fungsi tombol pada website untuk menjalankan OBS Scenes dan Sources.<br>â€¢ Membuat tombol pintasan dan pengaturan tombol pintasan untuk setiap fungsi yang terhubung ke OBS Scenes dan Sources.<br>â€¢ Membuat pengaturan Scenes, Sources, dan Profil di OBS.",
        ...
        "desc-modal-exp1": "Jobdesk saya selama masa jabatan saya:<br>â€¢ Berkoordinasi dengan guru tentang proyek publikasi.<br>â€¢ Membuat konsep video dan mengedit video acara.<br>â€¢ Membuat konsep dan mendesain feed Instagram.<br>â€¢ Berinteraksi dengan audiens dan berbagi informasi di Instagram.<br>â€¢ Mengoperasikan Live Streaming Youtube dan Instagram.",

        //Modal Exp2
        "title-modal-exp2": "Perayaan Paskah UKKK UPN Veteran Jatim",
        "time-modal-exp2": "Februari-April 2023",
        "role-modal-exp2": "Kepala Divisi Publikasi, Dokumentasi, dan Dekorasi",
        "desc-modal-exp2": "Jobdesk saya selama masa jabatan saya:<br>â€¢ Mengkoordinasikan tugas untuk tim dan menjadwalkan jadwal.<br>â€¢ Berkoordinasi dengan divisi lain untuk mengatur publikasi dan dekorasi.<br>â€¢ Berkomunikasi dan bernegosiasi dengan sponsor untuk mendapatkan sponsor.<br>â€¢ Membuat konsep publikasi.<br>â€¢ Mengedit video sneak peek, teaser, dan after movie.<br>â€¢ Mencapai 3.700+ penayangan di Instagram untuk teaser.<br>â€¢ Mendesain feed Instagram dan poster acara.",

        //Modal Exp3
        "title-modal-exp3": "OMKB UKKK UPN Veteran Jatim",
        "time-modal-exp3": "Juni-September 2023",
        "role-modal-exp3": "Kepala Divisi Publikasi dan Dokumentasi",
        "desc-modal-exp3": "Jobdesk saya selama masa jabatan saya::<br>â€¢ Memimpin tim dan menyusun jadwal program kerja.<br>â€¢ Berkoordinasi dengan divisi lain untuk mengatur konsep publikasi, merchandise, dan video-video.<br>â€¢ Berkomunikasi dan bernegosiasi dengan sponsor untuk mendapatkan sponsor.<br>â€¢ Membuat dan mengedit konsep desain.<br>â€¢ Mengedit video after movie<br>â€¢ Mendesain feed Instagram, informasi Technical Meeting, proposal sponsor, dan poster acara.",

        //Modal Exp4
        "title-modal-exp4": "GPIB Eben Haezer Surabaya",
        "time-modal-exp4": "Februari 2022-Sekarang",
        "role-modal-exp4": "Pengurus Divisi Informasi, Komunikasi, dan Multimedia",
        "desc-modal-exp4": "Jobdesk saya selama masa jabatan saya:<br>â€¢ Mengoperasikan Live Streaming kebaktian gereja.<br>â€¢ Menjadwalkan operator setiap tiga bulan sekali.<br>â€¢ Membuat konsep dan mendesain thumbnail Live Streaming.<br>â€¢ Membuat konsep dan mendesain tampilan Live Streaming.<br>â€¢ Membuat bumper video.",
